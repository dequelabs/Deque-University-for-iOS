...
@property (copy) void (^onButtonTouchUpInside)(CustomIOS7AlertView *alertView, long buttonIndex) ;
...
- (void)setOnButtonTouchUpInside:(void (^)(CustomIOS7AlertView *alertView, long buttonIndex))onButtonTouchUpInside;
