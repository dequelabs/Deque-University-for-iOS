...
@interface IACFormsValidationFixedViewController_test : XCTestCase

@property (strong, nonatomic) IACFormsValidationFixedViewController *controller;

@end


@implementation IACFormsValidationFixedViewController_test
